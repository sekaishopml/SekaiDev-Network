...
export const en = {
  ...
  NAV_LINKS: [
    ...
    { label: "Pricing", href: "/precios", mobileOnly: false, index: 4 },
  ...
  FEATURED_CASE: {
    ...
    stageUi: {
      aria: "CyTaxi panel: app, ops CRM, map, and live GPS",
      product: "CyTaxi",
      live: "Live",
      status: "En route",
      pickup: "Pickup",
      ...
      crmTitle: "Operations",
      crmTrip: "Trip #1842",
      crmDriver: "Driver assigned",
      crmQueue: "Queue · 3 live",
      gps: "GPS",
    },
  },
  ...
  PRICING: {
    ...
    productPage: {
      ...
      faqLead: "Scope, timelines, and how we work — clear before we build.",
    },
    tiers: [
      {
        id: "express",
        ...
        includes: [
          ...
          "Offer copy hierarchy ready to convert",
          "Basic DNS + HTTPS",
          "Basic SEO, speed, and meta tags",
          "Hosting / go-live",
          "Contact form or message path ready",
      ...
      },
      {
        ...
        includes: [
          ...
          "Light motion on hero and key moments",
      ...
      },
      {
        ...
        includes: [
          ...
          "Admin or internal flows as scoped",
      ...
      },
      {
        ...
        includes: [
          ...
          "Weekly prioritization of bugs and improvements",
  ...
  FAQ_ITEMS: [
    ...
    },
    {
      ...
      answer:
        "Web Express starts from $349 USD (list $449). Brand Web from $699 (list $899) — our recommended package. Build Sprint from $999 (list $1,250) with 30 days of support. Express and Brand include 14 days post-launch. Product Partner from $499/month (ongoing support, 3-month minimum). Apps and platforms are quoted separately.",
    },
    {

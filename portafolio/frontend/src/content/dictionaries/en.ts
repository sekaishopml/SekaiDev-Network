...
export const en = {
  ...
  PRICING: {
    ...
    subline:
      "Starting amounts in USD for Ecuador and LatAm. Scroll to compare — final number in writing.",
    marketNote:
  ...
  LEAD_FLOW_DEMO: {
    ...
    sampleLeads: [
      ...
      },
      {
        ...
        budget: "Monthly retainer ($3.8k+ / mo)",
        priority: "high",
        status: "qualified",

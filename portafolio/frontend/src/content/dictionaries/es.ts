...
export const es = {
  ...
  NAV_LINKS: [
    ...
    { label: "Precios", href: "/precios", mobileOnly: false, index: 4 },
  ...
  PRICING: {
    ...
    productPage: {
      ...
      faqLead: "Alcance, plazos y cómo trabajamos — claro, antes de construir.",
    },
    tiers: [
      {
        id: "express",
        ...
        includes: [
          ...
          "Copy base de la oferta y jerarquía clara",
          "Dominio/DNS básico + HTTPS",
          "SEO básico, velocidad y meta tags",
          "Hosting / salida al aire",
          "Formulario o mensaje de contacto listo",
      ...
      },
      {
        ...
        includes: [
          ...
          "Dirección visual coherente con tu marca",
          "Motion ligero en hero y momentos clave",
      ...
      },
      {
        ...
        includes: [
          ...
          "Panel o flujos internos según alcance",
      ...
      },
      {
        ...
        includes: [
          ...
          "Priorización semanal de bugs y mejoras",
